             ...
             <div class="user-card">
               ...
               <svg width="110" height="110" viewBox="0 0 250 250" xmlns="http://www.w3.org/2000/svg" role="img"  class="center">
                 ...
                 <g stroke="none" stroke-width="0" clip-path="url(#scene)"> <!-- #### circle photo #####-->
                   <image href="images/kid7girl.jpg" width="250" height="260" /> <!-- the inner #### circle photo #####  -->
                 </g>
               </svg>
             </div> <!-- user cards -->
     </div>
           ...
           <div class="general">
             ...
             <div class="stats">
                 ...
                 <div>  
                   ...
                   <div class="valueDuration">11:00am-01:00pm</div>
                 </div>
             ...
             <div class="user-card">
               ...
               <svg width="110" height="110" viewBox="0 0 250 250" xmlns="http://www.w3.org/2000/svg" role="img"  class="center">
                <!-- aria-labelledby="title desc" caused an error in validator-->
                 ...
                 <circle cx="125" cy="125" r="120" fill="rgba(0,0,0,0.15)" />
                 <g stroke="none" stroke-width="0" clip-path="url(#scene)"> <!-- #### circle photo #####-->
                   <image href="images/kid4.jpg" width="250" height="260" />  <!-- the inner #### circle photo #####  -->
                 </g>
               </svg>
             </div> <!-- user cards -->
             
             <div class="more-info">
               <h1>Faisal Saud</h1><!-- colored name-->
             </div> 
     </div>
           </div> <!-- add class -->
           <div class="general">
             <h1>Faisal Saud</h1> <!-- white name-->
             <p> 
              <div class="coords">
                <span>No. of Kids:</span>
                <span>1</span>
             ...
             <div class="stats">
                 ...
                 <div>  
                   <div class="title">Duration</div>
                   <div class="valueDuration">06:00pm-08:00pm</div>
                 </div>
           ...
           <div class="user-card">
             ...
             <svg width="110" height="110" viewBox="0 0 250 250" xmlns="http://www.w3.org/2000/svg" role="img"  class="center">
              <!-- aria-labelledby="title desc" caused an error in validator-->
               ...
               <circle cx="125" cy="125" r="120" fill="rgba(0,0,0,0.15)" />
               <g stroke="none" stroke-width="0" clip-path="url(#scene)"> <!-- #### circle photo #####-->
                 <image href="images/kid3girl.jpg" width="250" height="260" /> <!-- the inner #### circle photo #####  -->
               </g>
             </svg>
           </div> <!-- user cards -->
           
           <div class="more-info">
             <h1>Rema Khalid</h1><!-- colored name-->
           </div> 
   
         </div> <!-- add class -->
         <div class="general">
           <h1>Rema Khalid</h1> <!-- white name-->
           <p> 
            <div class="coords">
              <span>No. of Kids:</span>
              <span>1</span>
           ...
           <div class="stats">
               ...
               <div>  
                 <div class="title">Duration</div>
                 <div class="valueDuration">03:00pm-08:00pm</div>
               </div>
