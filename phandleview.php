...
if(count($errors)==0){
    ...
    //update query
    $query = "UPDATE parent SET parent_image='$TargetPath' , name='$username' ,email='$email', password='$password',city='$city',district='$district',street='$street',bulidingNo='$buildingNo',phoneNo='$phone' WHERE id=$id  " ;
